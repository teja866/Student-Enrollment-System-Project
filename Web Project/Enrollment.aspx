<%@ Page Title="Enrollment" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Enrollment.aspx.cs" Inherits="Web_Project.Enrollment" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="enroll-page">
        <div class="enroll-inner">
            ...
            <div class="enroll-eyebrow">
                <span class="pulse-dot"></span>
                Enrollment Center
            </div>

            <h2 class="enroll-title">Course Enrollment</h2>
            ...
            <div class="enroll-form-card">
                ...
                <br />
                <asp:Button ID="btnEnroll" runat="server" Text="Enroll" OnClick="btnEnroll_Click" CssClass="enroll-btn" />
                <asp:Label ID="lblMsg" runat="server" CssClass="msg-text"></asp:Label>
            </div>

            <div class="sec-label">
                <span class="sec-label-text">My Enrolled Courses</span>
